...
func (m *PreviousCompounding) GetTimestamp() string {
	if m != nil {
		return m.Timestamp
	}
	return ""
...
func (m *PreviousCompounding) GetBlockHeight() int32 {
	if m != nil {
...
var fileDescriptor_8d087eb4e48cdf20 = []byte{
	...
	,
}
...
func (m *PreviousCompounding) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.BlockHeight != 0 {
		i = encodeVarintPreviousCompounding(dAtA, i, uint64(m.BlockHeight))
		i--
		dAtA[i] = 0x18
	}
	if len(m.Timestamp) > 0 {
		...
		i = encodeVarintPreviousCompounding(dAtA, i, uint64(len(m.Timestamp)))
		i--
		dAtA[i] = 0x12
	}
...
func (m *PreviousCompounding) Size() (n int) {
	...
	if m.BlockHeight != 0 {
		n += 1 + sovPreviousCompounding(uint64(m.BlockHeight))
	}
	return n
}
