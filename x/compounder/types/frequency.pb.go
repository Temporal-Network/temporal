...
type Frequency struct {
	OnceEvery       int32  `protobuf:"varint,1,opt,name=onceEvery,proto3" json:"onceEvery,omitempty"`
...
func (m *Frequency) GetOnceEvery() int32 {
	if m != nil {
		return m.OnceEvery
	}
	return 0
...
var fileDescriptor_a1c44afb22d08196 = []byte{
	...
	0x12, 0x86, 0x29, 0xd2, 0x43, 0x28, 0x52, 0x0a, 0xe6, 0xe2, 0x74, 0x83, 0xa9, 0x13, 0x92, 0xe1,
	0xe2, 0xcc, 0xcf, 0x4b, 0x4e, 0x75, 0x2d, 0x4b, 0x2d, 0xaa, 0x94, 0x60, 0x54, 0x60, 0xd4, 0x60,
	0x0d, 0x42, 0x08, 0x08, 0x69, 0x70, 0xf1, 0x17, 0xa7, 0x26, 0xe7, 0xe7, 0xa5, 0x14, 0xfb, 0x17,
	0x39, 0xe5, 0xe4, 0x27, 0x67, 0x17, 0x4b, 0x30, 0x29, 0x30, 0x6a, 0x70, 0x06, 0xa1, 0x0b, 0x3b,
	0x99, 0x9e, 0x78, 0x24, 0xc7, 0x78, 0xe1, 0x91, 0x1c, 0xe3, 0x83, 0x47, 0x72, 0x8c, 0x13, 0x1e,
	0xcb, 0x31, 0x5c, 0x78, 0x2c, 0xc7, 0x70, 0xe3, 0xb1, 0x1c, 0x43, 0x94, 0x34, 0xdc, 0xa1, 0x15,
	0xc8, 0x4e, 0x2d, 0xa9, 0x2c, 0x48, 0x2d, 0x4e, 0x62, 0x03, 0xbb, 0xd3, 0x18, 0x10, 0x00, 0x00,
	0xff, 0xff, 0x6f, 0xc2, 0x9f, 0x7d, 0xce, 0x00, 0x00, 0x00,
}
...
func (m *Frequency) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.OnceEvery != 0 {
		i = encodeVarintFrequency(dAtA, i, uint64(m.OnceEvery))
		i--
		dAtA[i] = 0x8
	}
...
func (m *Frequency) Size() (n int) {
	...
	_ = l
	if m.OnceEvery != 0 {
		n += 1 + sovFrequency(uint64(m.OnceEvery))
	}
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.OnceEvery |= int32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
