...
func NewMsgCreateRemoteContractCompoundSettings(creator string, contractRemoteZone int32, remoteDelegatorAddress string, compoundSettings string, frequencyInSeconds int32, remoteContractAddress string) *MsgCreateRemoteContractCompoundSettings {
...
func NewMsgUpdateRemoteContractCompoundSettings(creator string, id uint64, contractRemoteZone int32, remoteDelegatorAddress string, compoundSettings string, frequencyInSeconds int32, remoteContractAddress string) *MsgUpdateRemoteContractCompoundSettings {
