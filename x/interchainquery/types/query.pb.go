...
// source: temporal/interchainquery/v1/query.proto
...
func (*QueryPendingQueriesRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_ffd3fbc7c940cb71, []int{0}
}
...
func (*QueryPendingQueriesResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_ffd3fbc7c940cb71, []int{1}
}
...
func init() {
	proto.RegisterType((*QueryPendingQueriesRequest)(nil), "temporal.interchainquery.v1.QueryPendingQueriesRequest")
	proto.RegisterType((*QueryPendingQueriesResponse)(nil), "temporal.interchainquery.v1.QueryPendingQueriesResponse")
}

func init() {
	proto.RegisterFile("temporal/interchainquery/v1/query.proto", fileDescriptor_ffd3fbc7c940cb71)
}

var fileDescriptor_ffd3fbc7c940cb71 = []byte{
	// 310 bytes of a gzipped FileDescriptorProto
	,
	...
	0x7e, 0x2e, 0xdc, 0x38, 0xdd, 0xaa, 0xfc, 0xbc, 0x54, 0x84, 0xe1, 0x15, 0x18, 0xc6, 0x97, 0x54,
	0x16, 0xa4, 0x16, 0x27, 0xb1, 0x81, 0x63, 0xcd, 0x18, 0x10, 0x00, 0x00, 0xff, 0xff, 0xe4, 0xe4,
	0xc8, 0xf7, 0x5c, 0x02, 0x00, 0x00,
}
...
func (c *queryServiceClient) PendingQueries(ctx context.Context, in *QueryPendingQueriesRequest, opts ...grpc.CallOption) (*QueryPendingQueriesResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/temporal.interchainquery.v1.QueryService/PendingQueries", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _QueryService_PendingQueries_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/temporal.interchainquery.v1.QueryService/PendingQueries",
	}
...
var _QueryService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "temporal.interchainquery.v1.QueryService",
	...
	Metadata: "temporal/interchainquery/v1/query.proto",
}
